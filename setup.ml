...
(* OASIS_START *)
(* DO NOT EDIT (digest: 692d0ddd44f029729ea1d4dfd9295e5a) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mirage"; "Mirage_misc"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "i\184\024\003\176D\222\186\139\145\001\021I \249Q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
